...
JupyterLab extension providing commands to launch jupyter-server-proxy connections. Enables launching proxied services in either a new JupyterLab tab or a new browser tab via modal port selection.

**Technology Stack**:

- TypeScript for frontend extension
- Python packaging via hatchling
- JupyterLab 4.x extension API
- jupyter-releaser for CI/CD
